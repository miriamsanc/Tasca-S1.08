# Sprint-1 Tasca S1.08: TESTING
Exercicis de PHP practicant testing en PHP.
...
## Instal·lació
1. Clonar el repositori: git clone [Link](https://github.com/miriamsanc/Tasca-S1.08.git)
2. Instal·la PHPUnit amb Composer
3. Executa els tests a Git Bash: ./vendor/bin/phpunit
